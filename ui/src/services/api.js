...
export const scriptAPI = {
  generate: (jobId, hostVoice, guestVoice, targetAudience, scriptStyle) => {
...
export const generateScript = (jobId, hostVoice, guestVoice, targetAudience, scriptStyle) => {
  return scriptAPI.generate(jobId, hostVoice, guestVoice, targetAudience, scriptStyle).then(res => res.data);
};
