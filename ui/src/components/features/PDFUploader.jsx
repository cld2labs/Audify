...
import { validateDocumentFile, formatFileSize } from '@utils/helpers';
...
export const PDFUploader = ({ onSuccess }) => {
  ...
  const onDrop = useCallback(
    (acceptedFiles) => {
      ...
      const errors = validateDocumentFile(selectedFile);
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-600">
              Upload a document to transform it into an engaging Podcast conversation.
            </p>
          </div>
          ...
          {!file && (
            ...
            >
              ...
              <p className="text-xs text-gray-400">
                Maximum file size: 10MB | PDF, DOC, DOCX formats supported
              </p>
            </div>
          )}
            ...
            <div className="flex gap-2">
              ...
              <div className="text-sm text-blue-800">
                ...
                <ul className="list-disc list-inside space-y-1 text-blue-700">
                  <li>Use documents with selectable text (not scanned images)</li>
