...
export const AudioPlayer = ({ onReset }) => {
  ...
  const handleDownload = async () => {
    if (jobId) {
      ...
      if (blob) {
        downloadBlob(blob, `audify-${jobId}.mp3`);
      }
    }
  };
        ...
        <div className="space-y-6">
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-2">
              {isTTSAvailable ? 'Your Audify is Ready!' : 'Script Generation Complete!'}
            </h2>
            {isTTSAvailable ? (
              <p className="text-gray-600">
                Listen to your AI-generated Audify below
              </p>
            ) : (
              <p className="text-gray-600">
                Your Audify script has been successfully created
              </p>
            )}
          </div>
            ...
            <>
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                ...
                <div className="space-y-2 text-green-800">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span>Audify script generated with AI</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <svg className="w-5 h-5 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                ...
                <p className="text-blue-800 mb-3">
                  To generate the final Audify audio, you'll need to start the TTS (Text-to-Speech) service.
                </p>
